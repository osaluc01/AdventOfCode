...
#  at least five zeroes. The input to the MD5 hash is some secret key (your puzzle input,
...
#because the MD5 hash of abcdef609043 starts with five zeroes (000001dbbfa...), and it is the
...
while True:
    ...
    hash_object = hash.md5(data)
    hash_hex = hash_object.hexdigest()
    print(hash_hex)
    print(text)
    if hash_hex[:6] == "000000":
        print("bingo!", print(hash_hex))
        break
    else:
        x += 1
